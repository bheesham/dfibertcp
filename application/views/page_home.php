...
<div id="container">
	<p id="top-nav">
	 ...
	 &nbsp; <a href="index.php/Files/index" class="hover" title="View your downloaded files."><img src="style/folder.png" alt="house" />Files</a> 
	...
	?>
		...
		?>
			<div class="torrent-info-container torrent-container-<?php echo $tran_id; ?>">
				<div class="torrent-info">
					...
					<p>
						...
						Upload: <span id="upload-<?php echo $tran_id; ?>">N/A</span>/s&nbsp; 
						Download: <span id="download-<?php echo $tran_id; ?>">N/A</span>/s<br />
			...
			<div class="torrent-files" id="torrent-files-<?php echo $tran_id; ?>">
				<p>
					Loading...
				</p>
			</div>
