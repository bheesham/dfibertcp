// A minor modification by Bheesham Persaud (bheesham.persaud [(at)] live . ca)
// See Line 45
        ...
        return this.each(function() {
                ...
                var doVibration = function () {
                        ...
                        var stopVibration = function() {
                                ...
                                /*
									Modification by Bheesham - I set it to return to it's original position. Before sometimes it would
									be left on a small angle after vibrating.
								*/
								t.css({position: 'relative', top: '0px', left: '0px', WebkitTransform: 'rotate(0deg)' });
